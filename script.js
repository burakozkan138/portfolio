...
// get data from data.js file and set it to the page
fetch('data.js')
  .then(response => response.json())
  .then(data => {
    // Assuming data contains an array of items to be displayed on the page
    const container = document.querySelector('.data-container');
    data.forEach(item => {
      const element = document.createElement('div');
      element.className = 'data-item';
      element.textContent = item.name; // Adjust based on the structure of your data
